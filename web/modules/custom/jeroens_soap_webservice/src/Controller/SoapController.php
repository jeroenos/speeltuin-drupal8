...
namespace Drupal\jeroens_soap_webservice\Controller;
...
/**
 * Jeroens Soap Webservice Controller.
 */
class SoapController extends ControllerBase {
  ...
  public function handleGetRequest($endpoint, Request $request) {
    ...
    return [
      ...
      '#xsd_url' => $baseUrl . '/' . drupal_get_path('module', 'jeroens_soap_webservice') . '/xsd/obaDrupal.xsd',
      '#service_endpoint' => $baseUrl . '/services/jeroens_webservice/soap/' . $endpoint,
    ];
  }
  ...
  public function handleSoapRequest($endpoint, Request $request) {
    ...
    $wsdlUri = \Drupal::request()
      ->getSchemeAndHttpHost() . '/services/jeroens_webservice/soap/' . $endpoint . '/?wsdl=true';
    $soapClass = 'Drupal\jeroens_soap_webservice\Soap\PublicatieServiceClass';

    $classmap = [
      'drupalPublicatie' => 'Drupal\jeroens_soap_webservice\Soap\Types\DrupalPublicatie',
      'headerType' => 'Drupal\jeroens_soap_webservice\Soap\Types\HeaderType',
      'adresType' => 'Drupal\jeroens_soap_webservice\Soap\Types\AdresType',
      'domeinType' => 'Drupal\jeroens_soap_webservice\Soap\Types\DomeinType',
      'locatieType' => 'Drupal\jeroens_soap_webservice\Soap\Types\LocatieType',
      'maatregelenType' => 'Drupal\jeroens_soap_webservice\Soap\Types\MaatregelenType',
      'maatregelType' => 'Drupal\jeroens_soap_webservice\Soap\Types\MaatregelType',
      'objectType' => 'Drupal\jeroens_soap_webservice\Soap\Types\ObjectType',
      'onderwerpOordeelType' => 'Drupal\jeroens_soap_webservice\Soap\Types\OnderwerpOordeelType',
      'oordeelType' => 'Drupal\jeroens_soap_webservice\Soap\Types\OordeelType',
      'oordelenType' => 'Drupal\jeroens_soap_webservice\Soap\Types\OordelenType',
      'overtredingType' => 'Drupal\jeroens_soap_webservice\Soap\Types\OvertredingType',
      'publicatieType' => 'Drupal\jeroens_soap_webservice\Soap\Types\PublicatieType',
      'publicatiesType' => 'Drupal\jeroens_soap_webservice\Soap\Types\PublicatiesType',
    ];
    ...
    try {
      ...
      \Drupal::logger('jeroens_soap_webservice')
