...
namespace Drupal\jeroens_soap_webservice\Soap;

use Drupal\jeroens_soap_webservice\Soap\Types\DrupalPublicatie;
...
class PublicatieServiceClass {
   ...
   * Bulk update.
   *
   * @param \Drupal\jeroens_soap_webservice\Soap\Types\DrupalPublicatie $data
  ...
  public function publicatie(DrupalPublicatie $data) {
    ...
    foreach ($data->drupal->publicatie as $publicatie) {
      ...
      \Drupal::logger('jeroens_soap_webservice')->notice($message);
    }
