...
use Drupal\jeroens_soap_webservice\Soap\Types\ObjectType;
use Drupal\jeroens_soap_webservice\Soap\Types\DomeinType;
...
class BulkUpdateProcessor extends QueueWorkerBase {
  ...
  public function processItem($data) {
    ...
    \Drupal::logger('jeroens_soap_webservice')->notice(
    ...
    try {
      ...
      \Drupal::logger('jeroens_soap_webservice')->error('Could\'t save nnode', $err);
    }
  }
   ...
   *
   * @param \Drupal\jeroens_soap_webservice\Soap\Types\ObjectType $object
   *   Object data.
   */
